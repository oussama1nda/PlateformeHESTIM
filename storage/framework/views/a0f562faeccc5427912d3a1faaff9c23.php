...
<?php $__env->startSection('title', 'Gestion des Groupes'); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $groupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500"><?php echo e($groupe->departement ? $groupe->departement->nom : 'N/A'); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500"><?php echo e($groupe->effectif); ?> étudiants</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('admin.groupes.edit', $groupe)); ?>" class="text-blue-600 hover:text-blue-900">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.groupes.destroy', $groupe)); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr ? Cette action supprimera aussi les associations avec les étudiants.')" class="inline">
                                            <?php echo csrf_field(); ?>
...
<div id="groupeModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-1/2 shadow-lg rounded-md bg-white">
        ...
        <form action="<?php echo e(route('admin.groupes.store')); ?>" method="POST" class="space-y-4" id="groupeForm">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
            ...
            <div>
                ...
                <input type="text" name="nom" value="<?php echo e(old('nom')); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('nom') ? 'border-red-500' : ''); ?>" placeholder="Ex: 3ème Année Cycle d'Ingénieur">
                <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="effectif" value="<?php echo e(old('effectif', 0)); ?>" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="0">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\plateformehestim\resources\views/admin/groupes/index.blade.php ENDPATH**/ ?>