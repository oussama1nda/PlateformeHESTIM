                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-3">
                            ...
                            <?php if($cour->emploisDuTemps->whereIn('groupe_id', $groupes->pluck('id'))->count() > 0): ?>
                        ...
                        <p class="text-sm text-gray-600 mb-3">
                            <span class="font-semibold">Enseignant :</span> <?php echo e($cour->enseignant->name ?? 'N/A'); ?>
...
<?php /**PATH C:\Users\dell\Downloads\plateformehestim\resources\views/etudiant/dashboard.blade.php ENDPATH**/ ?>