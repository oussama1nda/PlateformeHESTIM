                ...
                <div class="space-y-3">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $emploisJour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="bg-gray-50 rounded-lg p-3 border-l-4 
                            <?php if($emploi->type_seance == 'cours'): ?> border-blue-500
                            <?php elseif($emploi->type_seance == 'td'): ?> border-green-500
                            <?php else: ?> border-purple-500
                            <?php endif; ?>">
                            <h4 class="font-semibold text-sm text-gray-800 mb-2"><?php echo e($cour->nom); ?></h4>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\plateformehestim\resources\views/enseignant/planning.blade.php ENDPATH**/ ?>