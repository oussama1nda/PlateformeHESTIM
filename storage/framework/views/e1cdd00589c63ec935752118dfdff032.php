                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $cours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($cour->nom); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($cour->code); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($cour->enseignant->name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php $__currentLoopData = $cour->groupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs mr-1"><?php echo e($groupe->nom); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-500">
                                    <?php if($cour->emploisDuTemps->count() > 0): ?>
                                        <?php $__currentLoopData = $cour->emploisDuTemps->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emploi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="mb-1">
                                                <span class="font-semibold"><?php echo e(ucfirst($emploi->jour)); ?></span>
                                                <span class="text-gray-600"><?php echo e(substr($emploi->heure_debut, 0, 5)); ?> - <?php echo e(substr($emploi->heure_fin, 0, 5)); ?></span>
                                                <span class="text-gray-500">(<?php echo e($emploi->salle->nom ?? 'N/A'); ?>)</span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($cour->emploisDuTemps->count() > 2): ?>
                                            <span class="text-xs text-gray-400">+<?php echo e($cour->emploisDuTemps->count() - 2); ?> autres</span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="text-gray-400">Non programmé</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($cour->volume_horaire); ?>h</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('admin.cours.edit', $cour)); ?>" class="text-blue-600 hover:text-blue-900">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.cours.destroy', $cour)); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr ?')" class="inline">
                                            <?php echo csrf_field(); ?>
...
<div id="coursModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-2/3 shadow-lg rounded-md bg-white max-h-[90vh] overflow-y-auto">
        ...
        <form action="<?php echo e(route('admin.cours.store')); ?>" method="POST" class="space-y-4" id="coursForm">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nom" value="<?php echo e(old('nom')); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('nom') ? 'border-red-500' : ''); ?>" placeholder="Ex: Mathématiques Avancées">
                    <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="code" value="<?php echo e(old('code')); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('code') ? 'border-red-500' : ''); ?>" placeholder="Ex: MATH301">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Description du cours"><?php echo e(old('description')); ?></textarea>
            </div>
                ...
                <div>
                    ...
                    <select name="enseignant_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white <?php echo e($errors->has('enseignant_id') ? 'border-red-500' : ''); ?>">
                        ...
                        <?php $__currentLoopData = \App\Models\User::where('role', 'enseignant')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enseignant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($enseignant->id); ?>" <?php echo e(old('enseignant_id') == $enseignant->id ? 'selected' : ''); ?>><?php echo e($enseignant->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div>
                    ...
                    <select name="departement_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white <?php echo e($errors->has('departement_id') ? 'border-red-500' : ''); ?>">
                        ...
                        <?php $__currentLoopData = \App\Models\Departement::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($departement->id); ?>" <?php echo e(old('departement_id') == $departement->id ? 'selected' : ''); ?>><?php echo e($departement->nom); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div>
                ...
                <select name="groupes[]" multiple required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white <?php echo e($errors->has('groupes') ? 'border-red-500' : ''); ?>" size="5">
                    <?php $__currentLoopData = \App\Models\Groupe::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($groupe->id); ?>" <?php echo e(in_array($groupe->id, old('groupes', [])) ? 'selected' : ''); ?>><?php echo e($groupe->nom); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <div>
                    ...
                    <select name="salle_id" id="salleSelect" required onchange="checkConflict()" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white <?php echo e($errors->has('salle_id') ? 'border-red-500' : ''); ?>">
                        ...
                        <?php $__currentLoopData = \App\Models\Salle::where('disponible', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($salle->id); ?>" <?php echo e(old('salle_id') == $salle->id ? 'selected' : ''); ?>><?php echo e($salle->nom); ?> (Capacité: <?php echo e($salle->capacite); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="volume_horaire" value="<?php echo e(old('volume_horaire')); ?>" required min="1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('volume_horaire') ? 'border-red-500' : ''); ?>" placeholder="Ex: 30">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="jour" id="jourSelect" required onchange="checkConflict()" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white <?php echo e($errors->has('jour') ? 'border-red-500' : ''); ?>">
                            ...
                            <option value="lundi" <?php echo e(old('jour') == 'lundi' ? 'selected' : ''); ?>>Lundi</option>
                            <option value="mardi" <?php echo e(old('jour') == 'mardi' ? 'selected' : ''); ?>>Mardi</option>
                            <option value="mercredi" <?php echo e(old('jour') == 'mercredi' ? 'selected' : ''); ?>>Mercredi</option>
                            <option value="jeudi" <?php echo e(old('jour') == 'jeudi' ? 'selected' : ''); ?>>Jeudi</option>
                            <option value="vendredi" <?php echo e(old('jour') == 'vendredi' ? 'selected' : ''); ?>>Vendredi</option>
                            <option value="samedi" <?php echo e(old('jour') == 'samedi' ? 'selected' : ''); ?>>Samedi</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="type_seance" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white">
                            <option value="cours" <?php echo e(old('type_seance') == 'cours' ? 'selected' : ''); ?>>Cours</option>
                            <option value="td" <?php echo e(old('type_seance') == 'td' ? 'selected' : ''); ?>>TD</option>
                            <option value="tp" <?php echo e(old('type_seance') == 'tp' ? 'selected' : ''); ?>>TP</option>
                        </select>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_debut" value="<?php echo e(old('date_debut')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                
                <div class="mt-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Date de fin</label>
                    <input type="date" name="date_fin" value="<?php echo e(old('date_fin')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\plateformehestim\resources\views/admin/cours/index.blade.php ENDPATH**/ ?>