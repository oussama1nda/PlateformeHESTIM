...
<?php $__env->startSection('page-title', 'Tableau De bord ' . ucfirst(auth()->user()->role)); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-gray-200 rounded-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800"><?php echo e(strtoupper(auth()->user()->name)); ?></h2>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800"><?php echo e(auth()->user()->telephone ?: 'Non renseigné'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800"><?php echo e(auth()->user()->departement ? auth()->user()->departement->nom : 'Administration'); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\plateformehestim\resources\views/profile.blade.php ENDPATH**/ ?>