                ...
                <div class="space-y-3">
                    ...
                    @forelse($emploisJour as $item)
                        @php
                            ...
                            $emploi = $item['emploi'];
                        @endphp
                        <a href="{{ route('etudiant.reservations', ['cours_id' => $cour->id, 'emploi_id' => $emploi->id]) }}" 
                           class="block bg-gray-50 rounded-lg p-3 border-l-4 hover:bg-gray-100 transition cursor-pointer
                            @if($emploi->type_seance == 'cours') border-blue-500 hover:border-blue-600
                            @elseif($emploi->type_seance == 'td') border-green-500 hover:border-green-600
                            @else border-purple-500 hover:border-purple-600
                            @endif">
                            <div class="flex items-start justify-between mb-2">
                                <h4 class="font-semibold text-sm text-gray-800">{{ $cour->nom }}</h4>
