...
<div class="space-y-6">
    ...
    @if($selectedCours && $selectedEmploi)
        ...
        <div class="flex items-center space-x-2">
            <a href="{{ route('etudiant.emploi-du-temps') }}" class="flex items-center space-x-2 text-gray-600 hover:text-blue-600 transition">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        @else
        <div id="courseSelectionForm" class="{{ $selectedCours && $selectedEmploi ? 'hidden' : '' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="emploi_id" id="emploiSelect" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white">
                        ...
                        @if($selectedCours)
                            @if($selectedCours->emploisDuTemps->isEmpty())
                    ...
                    @if($selectedCours && $selectedCours->emploisDuTemps->isEmpty())
...
<script>
    function updateEmplois() {
        ...
        if (coursId) {
            ...
            window.location.href = '{{ route("etudiant.reservations") }}';
        }
    }
